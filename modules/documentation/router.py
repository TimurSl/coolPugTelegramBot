...
DEFAULT_TEXTS = {
    ...
    "documentation.sections.moderation.content.8": "<b>/restrict</b> — list members with a specific moderation level (add <code>mention=on</code> to include profile links).",
    ...
    "documentation.sections.moderation.content.12": "<b>/mods</b> — show every moderator grouped by level (add <code>mention=on</code> to include profile links).",
